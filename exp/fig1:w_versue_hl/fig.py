...
def main():
    ...
    x_axis = np.arange(args.start,args.end,args.step).tolist()
    ...
    ax.set(xlim=(args.start-args.step, args.end), xticks=x_axis,
        ylim=(0.55, 0.75), yticks=np.arange(0.55, 0.75, 0.025))
    plt.show()
